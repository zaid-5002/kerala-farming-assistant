...
const translations = {
  ...
  TE: {
    heroTitle: "AI మార్గదర్శకత్వంతో మెరుగైన పంటలు పండించండి",
    heroSub: "పంటలు, తెగుళ్ళు, నీటిపారుదల, ఎరువులు, వాతావరణం మరియు ప్రభుత్వ పథకాలపై నిపుణుల మార్గదర్శకత్వం — అన్నీ ఒకే చోట.",
    startChat: "చాట్ ప్రారంభించు",
    exploreFeatures: "లక్షణాలు చూడండి",
    askAI: "AI ని అడగండి",
    featuresTitle: "నేను దేంట్లో సహాయపడగలను?",
    chatTitle: "మీ వ్యవసాయ ప్రశ్న అడగండి",
    howTitle: "ఇది ఎలా పనిచేస్తుంది",
    trustTitle: "రైతులు మాపై నమ్మకం ఉంచడానికి కారణం",
    testimonialsTitle: "రైతుల విజయ కథలు",
    faqTitle: "తరచుగా అడిగే ప్రశ్నలు",
    ctaTitle: "మీ వ్యవసాయాన్ని మెరుగుపరచడానికి సిద్ధంగా ఉన్నారా?",
    ctaSub: "AI ఆధారిత తక్షణ వ్యవసాయ మార్గదర్శకత్వం పొందండి. ఉచితం.",
    ctaBtn: "ప్రశ్నలు అడగడం ప్రారంభించండి 🌾",
    schemesTitle: "ప్రభుత్వ పథకాలు & రైతు ప్రయోజనాలు",
    schemesSub: "కేరళ రైతులకు సబ్సిడీలు, బీమా, ఆర్థిక సహాయం కనుగొనండి.",
    methodsTitle: "ఆధునిక వ్యవసాయ పద్ధతులు",
    methodsSub: "ఉత్పాదకత మరియు స్థిరత్వాన్ని మెరుగుపరచడానికి నిరూపితమైన పద్ధతులు.",
    precautionsTitle: "అవసరమైన వ్యవసాయ జాగ్రత్తలు",
    inputPlaceholder: "పంటలు, తెగుళ్ళు, నీటిపారుదల గురించి అడగండి...",
    online: "ఆన్‌లైన్",
...
export default function KeralaFarmingAssistant() {
  ...
  const handleSend = async (e, text = null) => {
    ...
    setInputValue('');
    setLoading(true);
    const ctx = `${district ? `Farmer is from ${district} district, Kerala.` : 'Farmer is from Kerala.'} Respond in ${lang === 'ML' ? 'Malayalam' : lang === 'HI' ? 'Hindi' : lang === 'TA' ? 'Tamil' : lang === 'TE' ? 'Telugu' : 'English'}.`;
    try {
      ...
      <div className={`${bg} ${tx} min-h-screen transition-colors duration-300`}>
        ...
        <nav className={`fixed top-0 w-full z-50 border-b ${navCls} backdrop-blur-md`}>
          <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between gap-3">
            ...
            <div className="hidden md:flex items-center gap-5 text-sm font-medium">
              {[['home','Home'],['features','Features'],['how-it-works','How It Works'],['schemes','Schemes'],['faq','FAQ'],['chat-section','Chat']].map(([id, label]) => (
        ...
        <section id="home" className="pt-20 pb-10 px-4">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center min-h-[88vh]">
            ...
            <div ref={statsRef} className="relative rounded-2xl overflow-hidden shadow-2xl" style={{minHeight: '420px'}}>
              <img
                src="/hero-farmer.png"
              ...
              />
              {/* Gradient overlay — covers baked-in text on image */}
              <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/30 to-transparent rounded-2xl"></div>

              {/* Stats glassmorphism overlay — bottom */}
              <div className="absolute bottom-0 left-0 right-0 p-4">
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  {[
                    ...
                    { val: counts.d || 14, label: 'Districts Supported' },
                  ].map((stat, i) => (
                    <div key={i} className="bg-white/15 backdrop-blur-md border border-white/25 rounded-xl px-3 py-2 text-center">
                      <div className="text-white font-bold text-base leading-tight">{stat.val}</div>
                      <div className="text-white/80 text-xs leading-tight mt-0.5">{stat.label}</div>
                    </div>
                  ))}
                </div>
              </div>
        ...
        {/* GOVERNMENT SCHEMES */}
        <section id="schemes" className={`py-16 px-4 ${dm ? 'bg-gray-900' : 'bg-gray-50'}`}>
          <div className="max-w-7xl mx-auto">
