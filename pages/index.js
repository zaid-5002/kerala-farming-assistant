...
export default function KeralaFarmingAssistant() {
  ...
  const testimonials = [
    ...
    { name: 'Abdul Rahman', loc: 'Malappuram', text: 'The irrigation advice reduced my water usage by 40%. Excellent tool for farmers.', stars: 5 },
              ...
              <div className={`border-t ${dm ? 'border-gray-800 bg-gray-900' : 'border-gray-100 bg-white'} p-4`}>
                <form onSubmit={handleSend} className="flex gap-2">
                  <input
                    ...
                    className={`flex-1 px-4 py-2.5 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-green-500 ${dm ? 'bg-gray-800 border-gray-700 text-gray-200 placeholder-gray-500' : 'bg-gray-50 border-gray-200 text-gray-800 placeholder-gray-400'}`}
                    disabled={loading}
                  />
